`flatMap()` Мы используем тогда когда нам нужно поработать не с самими элементами коллекции а с элементами элементов нашей коллекции 

Например, нужно вывести имена всех студентов на наших факультетах:
```java
